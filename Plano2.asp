...
<script>
	function cd(CategoriaID){
		location.href="<%="./?P=ContasCD&Pers=1&T=D&De="&De&"&Ate="&Ate&"&U="&U&"&CategoriaID="%>"+CategoriaID;
	}
</script>
    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <ul class="pagination pagination-md pull-right">
                ...
                <li><button class="btn btn-default" type="button" onClick="excel()"><i class="far fa-file-excel-o"></i></button></li>
...
<table>
    <tr>
        <td data-verify='0090' >UM</td>
        <td data-verify='0090' >com conclick</td>
        <td data-verify='0090' >TRÊS</td>
    </tr>
    <tr>
        <td data-verify='0090' data-title='1'>PÁGINA UM</td>
    </tr>
    <tr>
        <td data-verify='0090' >Cell 1</td><td data-verify='0090' >Cell 2</td>
    </tr>
    <tr>
        <td data-verify='0090' data-title='1'>PAGINA DOIS</td>
        <td data-verify='0090'>celulite da pagina 2</td>
    </tr>
    <tr><td data-verify='0090' >Cell 11</td><td data-verify='0090' >Cell 22</td></tr><tr><td data-verify='0090' data-title='1'>PEDRO LUCAS</td></tr><tr><td data-verify='0090' >a</td><td data-verify='0090' >b</td><td data-verify='0090' >c</td></tr><tr><td data-verify='0090' >d</td><td data-verify='0090' >e</td><td data-verify='0090' >f</td></tr>
    <tr><td data-verify='0090' data-title='1'>Carlito Alfajor</td></tr><tr><td data-verify='0090' >A</td><td data-verify='0090' >B</td><td data-verify='0090' >C</td></tr><tr><td data-verify='0090' >AA</td><td data-verify='0090' >BB</td><td data-verify='0090' >CC</td></tr></table>
...
for i=0 to ubound(spl)
	...
	if spl(i)="RECEITAS" then
		...
		set movs = db.execute("select m.*, (select count(id) from sys_financialmovement WHERE InvoiceID=m.InvoiceID) Parcelas, (select SUM(Value) from sys_financialmovement WHERE InvoiceID=m.InvoiceID) TotalInvoice FROM sys_financialmovement m LEFT JOIN sys_financialinvoices i on m.InvoiceID=i.id WHERE month(m.Date)="&Mes&" AND year(m.Date)="&Ano&" AND m.CD='D' AND m.Type='Bill' AND i.CompanyUnitID in ("&replace(req("U"), "|", "")&")")
		while not movs.eof
...
'				response.Write("- &gt; Total do item: "&ValorItem&" - Percentual item: "&PercItem&" - Valor Proporcional: "&ValorProp&" - Categoria: "&itens("CategoriaID")&"<br>")
	...
	sqlVal = "select sum(Valor) cTotal from cliniccentral.rel_analise where UsuarioID="&session("User")
...
function excel(){
    N = "Analise_de_Despesas"
    $.post("excel.asp?T=S", {cont: $("#tb").html()}, function(data){
        location.href="relatorioExcel/main.php?N="+N;
    });
}
</script>