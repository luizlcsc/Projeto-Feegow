    ...
    <form action="" id="buscaRepasses" name="buscaRepasses" method="get">
        ...
        <div class="panel">
            <div class="panel-body hidden-print">
                ...
                <div class="row">
                    <div class="col-md-2 pt20 checkbox-custom checkbox-warning">
...
function lancaRepasses(rps, vlr, cc, tipo){
	...
	$.ajax({
		type:"POST",
		url:"calculaRepasse.asp?rps="+rps+"&vlr="+vlr+"&cc="+ cc +"&tipo="+ tipo,
