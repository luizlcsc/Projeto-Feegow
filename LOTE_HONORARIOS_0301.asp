                ...
                <ans:guiaHonorarios>
                    ...
                    <ans:localContratado>
                        <ans:codigoContratado>
                            <ans:<%=tipoCodigoNaOperadoraContratadoSolicitante%>><%=ContratadoLocalCodigoNaOperadora %></ans:<%=tipoCodigoNaOperadoraContratadoSolicitante%>>
                        </ans:codigoContratado>
					...
					while not procs.eof
						...
						if TabelaID="99" or TabelaID="101" then
							TabelaID="00"
						end if
