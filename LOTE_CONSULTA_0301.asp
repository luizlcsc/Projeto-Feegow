...
<ans:mensagemTISS xsi:schemaLocation="http://www.ans.gov.br/padroes/tiss/schemas tissV3_03_01.xsd" xmlns:ans="http://www.ans.gov.br/padroes/tiss/schemas" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<ans:cabecalho>
		...
		<ans:origem>
			<ans:identificacaoPrestador>
                ...
                CodigoNaOperadora = TiraTracos(CodigoNaOperadora)
                PodeSerCNPJ = 0
                if instr(CodigoNaOperadora, "/")>0 then
                    PodeSerCNPJ=1
                end if
		...
		<ans:loteGuias>
			...
			<ans:guiasTISS>
				...
				while not guias.eof
					...
					Observacoes = TirarAcento(guias("Observacoes"))
					...
					ConselhoProfissional = zeroEsq(guias("ConselhoProfissional"), 2)
                ...
                <ans:guiaConsulta>
					...
					if Observacoes<>"" and not isnull(Observacoes) then
                    %>
                    <ans:observacao><%=Observacoes%></ans:observacao>
                    <%
                    end if
               %></ans:guiaConsulta><%
				guias.movenext
