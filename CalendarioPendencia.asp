...
if day("01/02/2009")=1 then
        ...
        response.Write """ id="""&DataClick&""">" & strong & aBadge& "<input type='checkbox' name='Datas' id='data-"&DataClick&"' value='"&DataClick&"'/><label for='data-"&DataClick&"'>"& iCurrent & "</label> "&fBadge%>
		<%
