...
<div class="panel-heading">
    <span class="panel-title"><i class="far fa-print"></i> Entrega de Laudo (PDF) <small>&raquo; por <%= session("nameUser") %></small></span>
</div>
...
<div class="panel-footer text-right">
    ...
    <div class="btn-group">
        ...
        <a href="javascript:saveLaudo(); openPrint();" class="btn btn-sm btn-info"><i class="far fa-print"></i> ENTREGAR E IMPRIMIR</a>
