...
'    header = header & "        <div class=""widget-toolbar""><div>"
	if recurso="sys_financialinvoices" then
		...
		if session("Banco") = "clinic2496" OR session("Banco") = "clinic100000" OR session("Banco") = "clinic4285" Then
...
function newrep()
    if session("banco")="clinic2263" or session("banco")="clinic3656" or session("banco")="clinic105" or session("banco")="clinic100000" then
        newrep = 1
    else
        newrep = 0
    end if
