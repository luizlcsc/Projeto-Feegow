...
for (var i=0; i < 2; i++){		
	...
	cord = 30;
 	...
 	jg.setFont("arial", "14px", Font.PLAIN);		
	jg.drawString("<== E. A", (ubicX-5) + tamano*11, (ubicY + tamano*filas)+5);
	jg.drawString("<== E. O", (ubicX-5) + tamano*11, (ubicY + tamano*filas)+30);
...
for (var i=0; i < 2; i++){		
	...
	cord = 30;
 	...
 	jgi.setFont("arial", "14px", Font.PLAIN);	
	jgi.drawString("<== E. A", (ubicX-5) + tamano*11, (ubicY + tamano*filas)+5);
	jgi.drawString("<== E. O", (ubicX-5) + tamano*11, (ubicY + tamano*filas)+30);	
