...
<div class="modal-body">
    <iframe width="100%" height="170" frameborder="0" scrolling="no" src="dropzone.php?PacienteID=0&MovementID=<%=ref("movementID")%>&Tipo=A&L=<%= replace(session("Banco"), "clinic", "") %>&Pasta=Arquivos"></iframe>
