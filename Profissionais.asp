                ...
                <div class="col-md-10">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <%= quickfield("multiple", "SomenteConvenios", "Convênios para agendamento", 3, reg("SomenteConvenios"), "(select '|NONE|' id, 'NÃO PERMITIR CONVÊNIO' NomeConvenio) UNION ALL (select id, NomeConvenio from convenios where sysActive=1 order by NomeConvenio)", "NomeConvenio", "") %>
