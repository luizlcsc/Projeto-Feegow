...
if FC_ADS_ID<>"" then
%>
<!-- Global site tag (gtag.js) - Google Ads: 961944512 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=<%=FC_ADS_ID%>"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', '<%=FC_ADS_ID%>');
</script>

   <script>
    gtag('event', 'conversion', {'send_to': '<%=FC_ADS_ID%>/t_lYCPGAzZoBEMC32MoD'});
    </script>
<%
end if
%>
...
<script>
    ...
    fbq('init', '2273435169590668');
    fbq('track', 'PageView');
</script>

<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=2273435169590668&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
