...
db_execute("update profissionais set MaximoEncaixes="&treatvalnull(ref("MaximoEncaixes"))&", MinimoDeTempoEntreEncaixes="&treatvalnull(ref("MinimoDeTempoEntreEncaixes"))&", MaximoEncaixesEntreHorarios="&treatvalnull(ref("MaximoEncaixesEntreHorarios"))&" where id="&req("ProfissionalID"))
