...
function rtf2text($filename) {
    ...
    /* silvio desabilitou isto...    $text = file_get_contents($filename);*/
	/*e colocou isto....*/ $text = $filename;
    if (!strlen($text))
        return "";
...
//echo str_replace(chr(13), "<br>", rtf2text( file_get_contents("teste.rtf")));

//echo rtf2text($meuRTF);
