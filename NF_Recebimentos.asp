...
<div class="panel panel-body">
    <table class="table table-striped table-hover table-condensed table-bordered">
        ...
        <tbody>
            ...
            sql = "SELECT mPay.AccountAssociationIDCredit, mPay.AccountIDCredit,  i.NroNFe, i.DataNFe, ii.InvoiceID, i.ValorNFe, IFNULL(movCred.Date, mPay.Date) DataRecto, i.Value ValorBruto, "&_
            ...
            while not m.eof
                ...
                Multa = ccur(m("Multa"))
                ValorNFe = m("ValorNFe") ' !!!!!!!!!!! voltar a salvar o valor e data da nf
                    'ANTES DE TER VALORNFE
                '     ValorNFe = ccur(m("ValorBruto")) - Multa
                ValorBruto = ccur(m("ValorBruto"))
                Cofins = ccur(m("Cofins"))
                CSLL = ccur(m("CSLL"))
                IRPJ = ccur(m("IRPJ")) ' !!!! procurar com o nome de IRPJ ou IRRF
                PIS = ccur(m("PIS"))
                ISS = ValorNFe*0.05
