...
if FALSE AND session("Franqueador")<>"" and "clinic"&session("FranqueadorID")=session("Banco") then
    ...
    <li class="<%=classMenu %>">
        <a href="#" class="dropdown-toggle menu-click-agenda" onclick="return false;" data-toggle="dropdown">
            <%=abreSpanTitulo %> <i class="fa fa-calendar hidden"></i> <span class=""> Agenda </span> <%= fechaSpanTitulo %>
        </a>
        <ul class="dropdown-menu">
            <li class="sub-menu-click-agenda-diaria"><a href="./?P=Agenda-1&Pers=1">Diária</a></li>
            <li class="sub-menu-click-agenda-semanal"><a href="./?P=Agenda-S&Pers=1">Semanal</a></li>
    ...
    <li class="<%=classMenu %>"><a href="#" class="dropdown-toggle menu-click-pacientes" data-toggle="dropdown">
        <%=abreSpanTitulo %> <i class="fa fa-user hidden"></i> <span class=""> Pacientes </span> <%= fechaSpanTitulo %>
		    ...
		    if aut("lctestoque")=1 or aut("produtos")=1 or aut("requisicaoestoqueV")=1 then
                if 1=2 and (session("Banco")="clinic2803" or session("Banco")="clinic100000") then
                    ...
                    <li class="<%=classMenu %>"><a href="#" class="dropdown-toggle menu-click-estoque" data-toggle="dropdown">
                        <%=abreSpanTitulo %> <i class="fa fa-medkit hidden"></i> <span class=""> Estoque </span> <%= fechaSpanTitulo %>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            %>
                            <li>
                                <a href="?P=ProdutosKits&Pers=Follow"><i class="fa fa-medkit"></i> Kits de Produtos</a>
                            </li>
                             <%
                                    end if
    ...
    <li class="<%=classMenu %>"><a href="./?P=Financeiro&Pers=1" class="menu-click-financeiro">
        <%=abreSpanTitulo %> <i class="fa fa-money hidden"></i> <span class=""> Financeiro </span> <%= fechaSpanTitulo %>
        </a></li>
    <%
		    end if
    %>
    ...
    <li class="<%=classMenu %>"><a href="#" class="dropdown-toggle menu-click-tiss" data-toggle="dropdown">
        <%=abreSpanTitulo %> <i class="fa fa-credit-card hidden"></i> <span class=""> TISS</span> <%= fechaSpanTitulo %>
                                              </a>
        <ul class="dropdown-menu">
            <%
            ...
            %>
            <li>
                <a href="?P=tissguiaconsulta&I=N&Pers=1"><i class="fa fa-plus"></i> Inserir Guia de Consulta</a>
            </li>
        
            <li>
                <a href="?P=tissguiasadt&I=N&Pers=1"><i class="fa fa-plus"></i> Inserir Guia de SP/SADT</a>
            </li>
        
            <li>
                <a href="?P=tissGuiaHonorarios&I=N&Pers=1"><i class="fa fa-plus"></i> Inserir Guia de Honorários</a>
            </li>
            ...
            %>
            <li>
                <a href="?P=tissbuscaguias&Pers=1"><i class="fa fa-list"></i> Buscar Guias</a>
            </li>
            <%
            if aut("loteI")=1  then
            %>
            <li><a href="?P=tissfechalote&Pers=1"><i class="fa fa-archive"></i> Fechar Lote</a></li>
            <%
            end if
            if aut("loteV")=1  then
            %>
            <li><a href="?P=tisslotes&Pers=1"><i class="fa fa-folder-open"></i> Administrar Lotes</a></li>
            <%
            end if
            %>
            <li class="hidden"><a href="?P=validarlote&Pers=1"><i class="fa fa-check-square"></i> Validar Lote </a></li>
            <li><a href="?P=preXML&Pers=1"><i class="fa fa-upload"></i> Baixa de Retorno - XML <span class="label label-system label-xs fleft">Novo</span></a></li>
            <%
		    end if
            if aut("conveniosA")=1 then
                %>
                <li><a href="?P=ValoresItens&Pers=1"><i class="fa fa-money"></i> Valores de Itens  </a> </li>
                <%
            end if
            %>
    ...
    <li class="<%=classMenu %>"><a href="./?P=Relatorios&Pers=1" class="menu-click-relatorio">
        <%=abreSpanTitulo %> <i class="fa fa-bar-chart hidden"></i> <span class=""> Relat&oacute;rios</span> <%= fechaSpanTitulo %>
        </a></li>
    <%
		    end if
    %>
    ...
    <li class="<%=classMenu %>"><a href="#" class="dropdown-toggle menu-click-cadastros" data-toggle="dropdown">
        <%=abreSpanTitulo %> <i class="fa fa-database"></i> <span class="hidden-sm hidden"> Cadastros</span> <%= fechaSpanTitulo %>

                         </a>
        <ul class="dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
            <li class="dropdown-header"><i class="fa fa-database"></i> Cadastros</li>
            <%
    ...
    if device="" or lcase(req("P"))="cadastros" then
            ...
            %>
            <li><a class="sub-menu-click-cadastro-convenio" href="./?P=Convenios&Pers=Follow"><i class="fa fa-credit-card"></i> Conv&ecirc;nios</a></li>
            <%
            end if
            ...
            if aut("|sys_financialcurrentaccountsV|")=1  then
            %>
            <li><a class="sub-menu-click-cadastro-contas-fornecedores" href="./?P=contasbancarias&Pers=Follow"><i class="fa fa-university bigger-110"></i> Contas de Fornecedores</a></li>
            <%
            end if

            if aut("|equipamentosV|")=1  then
            %>
            <li><a class="sub-menu-click-cadastro-equipamentos" href="./?P=Equipamentos&Pers=Follow"><i class="fa fa-laptop"></i> Equipamentos</a></li>
            <%
            end if

            if aut("fornecedores")=1   then
            %>
            <li><a class="sub-menu-click-cadastro-fornecedores" href="./?P=Fornecedores&Pers=Follow"><i class="fa fa-archive bigger-110"></i> Fornecedores</a></li>
            <%
            end if

            if aut("funcionarios")=1   then
            %>
            <li><a class="sub-menu-click-cadastro-funcionarios" href="./?P=Funcionarios&Pers=Follow"><i class="fa fa-user bigger-110"></i> Funcion&aacute;rios</a></li>
            <%
            end if
            ...
            %>
            <li>
                <a href="?P=Locais&Pers=Follow" class="sub-menu-click-cadastro-locais-de-atendimentos"><i class="fa fa-map-marker"></i> Locais de Atendimento</a>
            </li>
            <%
            end if
            if aut("medicinaocupacional")=1 and false then
            %>
            <li><a class="sub-menu-click-cadastro-convenio" href="./?P=aso_funcao&Pers=Follow"><i class="fa fa-user-plus"></i> Medicina Ocupacional</a></li>
            <%
            end if
            if aut("procedimentos")=1  then
            %>
            <li><a href="./?P=Procedimentos&Pers=Follow" class="sub-menu-click-cadastro-procedimentos"><i class="fa fa-stethoscope"></i> Procedimentos</a></li>
            <%
            end if

            if aut("profissionais")=0 and aut("profissionalexterno")=1   then
            %>
            <li><a href="./?P=ProfissionalExterno&Pers=Follow" class="sub-menu-click-cadastro-profissionais-externos"><span class="fa fa-user-times bigger-110"></span> Profissionais externos</a></li>
            <%
            end if

            if aut("|profissionaisV|")=1 then
            %>
            <li><a href="./?P=Profissionais&Pers=Follow"  class="sub-menu-click-cadastro-profissionais" ><i class="fa fa-user-md bigger-110"></i> Profissionais</a></li>
            <%
            end if
            ...
            %>
            <li><a href="./?P=basedeconhecimento&Pers=Follow"  class="sub-menu-click-base-de-conhecimento" ><i class="fa fa-tasks bigger-110"></i> Base de Conhecimento</a></li>
            <%
            end if

            if aut("guiamanual")=1 and false then
            %>
            <li><a href="./?P=GuiaManual&Pers=1"  class="sub-menu-click-guia-manual" ><i class="fa fa-paste bigger-110"></i> Guia Manual</a></li>
            <%
            end if
    ...
    <li class="<%=classMenu %>"><a href="#" class="dropdown-toggle menu-click-configuracao" data-toggle="dropdown">
        <%=abreSpanTitulo %> <i class="fa fa-cog"></i> <span class="hidden-md hidden-xl hidden-lg hidden-sm"> Configurações</span> <%= fechaSpanTitulo %>
                         </a>
        <ul class="dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
            <li class="dropdown-header"><i class="fa fa-cog"></i> Configurações</li>
            <%
    end if
    if device()="" or lcase(req("P"))="configuracoes" then
			    if aut("origens")=1 then
            %>
            <li><a href="./?P=Origens&Pers=0"><i class="fa fa-list"></i> Origens</a></li>
            <%
			    end if
            ...
            <%
			    ...
			    if aut("configrateio")=1  then
                    arqP = "RepasseLinear"
            %>
            <li><a href="./?P=<%= arqP %>&Pers=1"><i class="fa fa-puzzle-piece bigger-110"></i> Regras de Repasse</a></li>
            <%
			    end if
			    if aut("eventos_emailsms")=1 then
            %>
            <li><a href="./?P=eventos_emailsms&Pers=Follow"><i class="fa fa-calendar bigger-110"></i> Eventos de e-mail e SMS</a></li>
            <%
			    end if

			    if aut("chamadaporvoz")=1  then
            %>
            <li><a href="./?P=ChamadaPorVoz&Pers=1"><i class="fa fa-volume-up bigger-110"></i> Chamada por Voz</a></li>
            <%
			    end if
			    if aut("sys_financialcompanyunits")=1 then
            %>
            <li><a href="./?P=empresa&Pers=1"><i class="fa fa-hospital-o bigger-110"></i> Empresa</a></li>
            <%
			    end if
			    if aut("centrocusto")=1  then
            %>
            <li><a href="./?P=CentroCusto"><i class="fa fa-sitemap bigger-110"></i> Centros de Custo</a></li>
            <%
			    end if
			    if aut("formasrecto")=1 then
            %>
            <li>
                <a href="?P=FormaRecto&Pers=1"><i class="fa fa-credit-card"></i> Formas de Recebimento</a>
            </li>
            <%
            end if
            ...
            %>
            <li>
                <a href="?P=chamadasresultados"><i class="fa fa-phone"></i> Resultados de Contato</a>
            </li>
            <%
            end if
            ...
            %>
            <li>
                <a href="?P=feriados&Pers=0"><i class="fa fa-road"></i> Feriados</a>
            </li>
            <%
            end if
            ...
            %>
            <li>
                <a href="?P=TabelaParticular&Pers=Follow"><i class="fa fa-table"></i> Tabelas Particulares </a>
            </li>
            <%
            end if
            ...
            %>
            <li>
                <a href="?P=TabelasPreco&Pers=1"><i class="fa fa-table"></i> Tabelas de Preço</a>
            </li>
            <%
            end if
            ...
            %>
            <li>
                <a href="?P=VariacoesPrecos&Pers=1"><i class="fa fa-dollar"></i> Variações de Preços</a>
            </li>
            <%
            end if
            ...
            %>
            <li>
                <a href="?P=EditaPlanoContas&Pers=1"><i class="fa fa-outdent"></i> Plano de Contas</a>
            </li>
            <%
            end if
            ...
            %>
            <li>
                <a href="?P=Treinamentos&Pers=1"><i class="fa fa-star"></i> Treinamento</a>
            </li>
            <li>
                <a href="?P=Implantacao&Pers=1"><i class="fa fa-star"></i> Implantação</a>
            </li>
            <%
            end if
    end if
