jQuery(function($){
	...
	$('.message-list .message-item:eq(0) .text').on('click', function() {
		...
		$('.message-container').append('<div class="message-loading-overlay"><i class="fa fa-spin icon-spinner orange2 bigger-160"></i></div>');
		...
		$('#id-add-attachment').on('click', function(){
			...
			.parent(/*.span7*/).append('<div class="action-buttons pull-right col-xs-1">\
				<a href="#" data-action="delete" class="middle">\
					<i class="fa fa-trash red bigger-130 middle"></i>\
				</a>\
