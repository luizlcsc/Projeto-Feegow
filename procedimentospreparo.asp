...
<div class="col-md-6">
    <div class="row">
        ...
        <div class="col-md-3">
            <button type="button" class="btn btn-success mt25 btn-block" onclick="ajxContent('procedimentospreparo&A=Ex&Conta='+ $('#Prestador').val(), <%= ProcedimentoID %>, 1, 'divEquipe')"><i class="fa fa-plus"></i> Adicionar</button>
        </div>
    </div>
    <hr class="short alt" />
    <div class="row">
                ...
                <tbody>
                    ...
                    while not prepEx.eof
                        ...
                        <tr class="linhaCX" onclick="$('.linhaCX').removeClass('system'); $(this).closest('tr').addClass('system')" style="cursor:pointer">
                            ...
                            <td>
                                <button type="button" class="btn btn-danger btn-xs" onclick="if(confirm('Tem certeza de que deseja apagar esta exceção e todos os preparos relacionados a elas?')) ajxContent('procedimentospreparo&A=XEx&Conta=<%= prepEx("Conta") %>', <%= ProcedimentoID %>, 1, 'divEquipe')"><i class="fa fa-remove"></i></button>
                            </td>
                        </tr>
                        <%
                    prepEx.movenext
