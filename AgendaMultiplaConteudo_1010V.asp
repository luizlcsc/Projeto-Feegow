    ...
    %>
             ...
             <table class="table table-striped table-condensed table-hover" width="100%">
                 ...
                 <%
                    ...
                    if Horarios("TipoGrade")=0 then
                        ...
                        while Hora<=HoraA
                            ...
                            %>
                            <tr onclick="abreAgenda('<%=HoraID%>', 0, '<%=Data%>', <%=LocalID%>, <%=ProfissionalID %>, '','<%=GradeID%>' )" class="p<%=ProfissionalID%> l<%= LocalID %>" data-pro="<%=ProfissionalID%>" data-id="<%=HoraID%>" data-hora="<%= ft(Hora) %>" id="<%=ProfissionalID&"_"&HoraID%>">
                    ...
                    if instr(txtHorarios, ",") then
                        ...
                        for ih=0 to ubound(splHorarios)
                            ...
                            if isdate(HoraPers) then
                                ...
                                %>
                                <tr onclick="abreAgenda('<%=HoraID%>', 0, '<%=Data%>', <%=LocalID%>, <%=ProfissionalID %>,'','<%=Horarios("id")%>' )" class="p<%=ProfissionalID%> l<%= LocalID %>" data-pro="<%=ProfissionalID%>" data-id="<%=HoraID%>" data-hora="<%= ft(HoraPers) %>" id="<%=ProfissionalID&"_"&HoraID%>">
                                    <td width="1%" style="background-color:<%=comGrade("Cor")%>"></td>
                ...
                $agendamentoSlot.each(function(){
                    ...
                    if( horaSlot=='<%=HoraComp%>' && Status !== '11')
                    {
                    ...
                    {
                        if($agendamentoSlot.filter("[data-id='<%=HoraComp%>']").length > 0){
