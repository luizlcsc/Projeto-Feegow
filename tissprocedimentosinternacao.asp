...
<table width="100%" class="table table-striped table-bordered table-condensed">
  <thead>
    <tr>
      ...
      <th width="3%" align="right" nowrap><button type="button" class="btn btn-info btn-xs" onClick="itemInternacao('Procedimentos', <%=request.QueryString("I")%>, 0);"><i class="fa fa-plus"></i></button></th>
    </tr>
  </thead>
  <tbody>
  <%
  ...
  %>
    <tr id="lProcedimentos<%=p("id") %>">
      ...
      <td align="center"><button type="button" class="btn btn-xs btn-success" onClick="itemInternacao('Procedimentos', <%=request.QueryString("I")%>, <%=p("id")%>);"><i class="fa fa-edit"></i></button></td>
      ...
      <td align="center"><button type="button" class="btn btn-xs btn-danger" onClick="atualizaTabela('tissprocedimentosinternacao', 'tissprocedimentosinternacao.asp?I=<%=request.QueryString("I")%>&X=<%=p("id")%>')"><i class="fa fa-remove"></i></button></td>
    </tr>
    <tr>
