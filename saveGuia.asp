...
if erro<>"" then
    ...
    if guiaExiste.eof or ForcarSalvar = "1" then
        ...
        sqlGuiaDisponivel = "SELECT numero, id, Tipo FROM  ((SELECT cast(gc.NGuiaPrestador as signed integer) numero, id, 'Consulta' as Tipo FROM tissguiaconsulta gc WHERE gc.ConvenioID = '"&ConvenioID&"') UNION ALL "&_
