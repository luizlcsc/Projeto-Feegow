...
<div class="panel-body">
    ...
    <table id="datatable2" class="table table-hover table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            if ref("fEspecialidadeID")<>"" then
                sqlEsp = " AND esp.id IN ("& ref("fEspecialidadeID") &") "
            end if
