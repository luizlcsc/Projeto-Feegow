...
<%
            ...
            objXML.load("C:\inetpub\wwwroot\feegowclinic\v7\xml-retorno\"& Arquivo) 
            ...
            set conv = db.execute("select id from convenios where registroANS='"& registroANS &"'")
            while not conv.eof
        ...
        <table class="table table-condensed table-hover table-bordered">
                ...
                for each conta in contas
                    ...
                    For Each guia in guias
                        ...
                        for each proc in procs
                            'Dim codigo : codigo = proc.getElementsByTagName("ans:codigo")(0).text
                            'Dim tipoTabela : tipoTabela = proc.getElementsByTagName("ans:tipoTabela")(0).text
                            'Dim valorInformado : valorInformado = proc.getElementsByTagName("ans:valorProcessado")(0).text
                            'Dim valorLiberado : valorLiberado = proc.getElementsByTagName("ans:valorLiberado")(0).text
                            'Dim grauParticipacao : grauParticipacao = proc.getElementsByTagName("ans:grauParticipacao")(0).text
                            'response.write("Código: "& codigo &" - Tabela: "& tipoTabela & " - Val. Proc.: " & valorInformado & " - Val. Lib.: " & valorLiberado & " - Grau Part.:" & grauParticipacao &"<br>")
                        next
                    Next
                next
            end if
            ...
            c = 0
            if versaoPadrao="3.03.02" then '36048832 - guia do novo pasta
                Set contas = objXML.getElementsByTagName("ans:demonstrativoAnaliseConta")
                for each conta in contas
                    c = c+1
                    'Response.Write conta.xml & "<br />" & vbCrLf
