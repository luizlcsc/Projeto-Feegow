...
<script>
    ...
    $("#frm-filtros").submit(function(){
        $("#GradeAgenda").html(`<div class="p10"><button type="button" class="close" data-dismiss="modal">×</button><center><i class="far fa-circle-o-notch fa-spin"></i> Carregando...</center></div>`)
