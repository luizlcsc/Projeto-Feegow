...
if Tipo="Profissionais" then
	...
	%>
    	<div class="row">
            ...
            <%= quickField("text", "UFConselho", "* UF", 1, UFConselho, "", "", " required='required' pattern='[a-zA-Z]{2}'") %>
...
elseif Tipo="Procedimentos" then
	...
	%>
        ...
        <div class="row">
            <%= quickField("number", "Quantidade", "* Quant.", 1, Quantidade, " text-right input-sm", "", " required='required' onkeyup=""tissRecalc('Quantidade');""") %>
            ...
            <%= quickField("currency", "ValorUnitario", "* Valor Unit&aacute;rio", 2, ValorUnitario, " input-sm", "", " "&ValorRequired&" onkeyup=""tissRecalc('ValorUnitario');""") %>
            <%= quickField("currency", "ValorTotal", "* Valor Total", 2, ValorTotal, " input-sm", "", " "&ValorRequired) %>
         </div>
	<%id = ItemID%>
...
elseif Tipo="Despesas" then
	...
	%>
  	<div class="row">
            ...
            <%= quickField("simpleSelect", "TabelaProdutoID", "* Tabela", 2, TabelaProdutoID, "select *, concat( right(concat('00', id), 2), ' - ', descricao) desccomp from tisstabelas order by id", "desccomp", " empty='' required='required' onchange=""tissCompletaDados(6, this.value+'_'+$('#ProdutoID').val());"" no-select2 ") %>
            <%= quickField("text", "CodigoProduto", "* C&oacute;digo do Item", 2, CodigoProduto, "", "", " required='required'") %>
        ...
        <div class="row">
            ...
            <%= quickField("number", "Quantidade", "Quantidade", 1, replace(Quantidade,",","."), " text-right", "", " required='required' onkeyup=""tissRecalc('Quantidade');"" step=""0.01""") %>
