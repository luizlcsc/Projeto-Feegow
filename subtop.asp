...
if not resource.EOF then
	...
	resourceDescription = "<small><i class=""fa fa-double-angle-right""></i> "&resource("description")&"</small>"
	if request("I")<>"" then
	...
	if resource("tablename")="sys_financialinvoices" then
		if request.QueryString("T")="C" then
			...
			resourceDescription = "<small><i class=""fa fa-double-angle-right""></i> edi&ccedil;&atilde;o de conta a pagar</small>"
		end if
	end if
else
...
<div class="breadcrumbs hidden-print" id="breadcrumbs">
    ...
    <div class="btn-group">
        <button class="btn btn-light btn-sm dropdown-toggle" onClick="location='./?P=Agenda-1&Pers=1';"><i class="fa fa-calendar-o align-top bigger-125"></i> Agenda</button>
        <button class="btn dropdown-toggle" data-toggle="dropdown">
            <span class="fa fa-caret-down icon-only"></span>
        </button>
        <ul class="dropdown-menu">
            ...
            <%
				if Aut("|agenda")=1 then
					%>
					<div class="btn-group">
						<button type="button" onClick="location.href='./?P=QuadroDisponibilidade&Pers=1';" class="btn btn-sm btn-light"><i class="fa fa-calendar align-top bigger-125"></i> Agenda M&uacute;ltipla</button>
					</div>
					<%
				end if
            else
            %>
            <div class="btn-group">
                <button type="button" class="btn btn-sm btn-light" id="btnAgenda"><i class="fa fa-calendar-o align-top bigger-125"></i> Agenda</button>
            </div>
            <%
				if Aut("agenda")=1 then
					%>
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-light" id="btnAgendaMultipla"><i class="fa fa-calendar align-top bigger-125"></i> Agenda M&uacute;ltipla</button>
                    </div>
                    <%
				end if
            end if
            %>
        <div class="btn-group">
            <button type="button" class="btn btn-sm btn-light" id="btnListaEspera"><i class="fa fa-clock-o align-top bigger-125"></i> Lista de Espera</button>
		</div>
		<%
		end if
        ...
        <div class="btn-group">
            <button class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-user align-top bigger-125"></i> Pacientes <span class="fa fa-caret-down icon-on-right"></span>
            </button>
            <ul class="dropdown-menu dropdown-info">
				...
				%>
                <li>
                    <a href="?P=Pacientes&I=N&Pers=1"><i class="fa fa-plus"></i> Inserir</a>
                </li>
                <%
				end if
				...
				%>
                <li>
                    <a href="?P=Pacientes&Pers=Follow"><i class="fa fa-list"></i> Listar</a>
                </li>
                <%
				end if
				%>
        ...
        <div class="btn-group">
            <button class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-mobile-phone align-top bigger-125"></i> Contatos <span class="fa fa-caret-down icon-on-right"></span>
            </button>
            <ul class="dropdown-menu dropdown-info">
            	<%
				...
				%>
                <li>
                    <a href="?P=Contatos&I=N&Pers=1"><i class="fa fa-plus"></i> Inserir</a>
                </li>
                <%
				end if
				...
				%>
                <li>
                    <a href="?P=Contatos&Pers=Follow"><i class="fa fa-list"></i> Listar</a>
                </li>
                <%
				end if
				%>
        ...
        <div class="btn-group">
            <button class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-medkit align-top bigger-125"></i> Estoque <span class="fa fa-caret-down icon-on-right"></span>
            </button>
            <ul class="dropdown-menu dropdown-info">
            	<%
        ...
        <div class="btn-group hidden">
            <button class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-puzzle-piece align-top bigger-125"></i> Or&ccedil;amentos <span class="fa fa-caret-down icon-on-right"></span>
            </button>
            <ul class="dropdown-menu dropdown-info">
            	<%
				...
				%>
                <li>
                    <a href="?P=unavailable&Pers=1"><i class="fa fa-plus"></i> Inserir</a>
                </li>
                <%
				end if
				...
				%>
                <li>
                    <a href="?P=unavailable&Pers=1"><i class="fa fa-list"></i> Listar</a>
                </li>
                <%
				end if
				%>
		...
		%>
            <button class="btn btn-light btn-sm" onClick="location.href='./?P=Financeiro&Pers=1';">
                <i class="fa fa-money align-top bigger-125"></i> Financeiro
            </button>
		<%
		end if
        ...
        <div class="btn-group">
            <button class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-exchange align-top bigger-125"></i> TISS <span class="fa fa-caret-down icon-on-right"></span>
            </button>
            <ul class="dropdown-menu dropdown-info">
            	<%
        ...
        <div class="btn-group" id="btnRelatorios">
			<button type="button" class="btn btn-light btn-sm"><i class="fa fa-bar-chart align-top bigger-125"></i> Relat&oacute;rios</button>
		</div>
        <%
		end if
		%>
