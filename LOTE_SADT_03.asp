...
versaoTISS = "3.02.03"
%>
<ans:mensagemTISS xsi:schemaLocation="http://www.ans.gov.br/padroes/tiss/schemas tissV3_02_02.xsd" xmlns:ans="http://www.ans.gov.br/padroes/tiss/schemas" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ans:cabecalho>
                ...
                <ans:guiaSP-SADT>
                    ...
                    <ans:dadosSolicitante>
                        <ans:contratadoSolicitante>
                            <%="<ans:" & tipoCodigoNaOperadora & ">" & ContratadoSolicitanteCodigoNaOperadora &"</ans:" & tipoCodigoNaOperadora &">"%>
                    ...
                    <ans:outrasDespesas>
						...
						while not desp.eof
							...
							TabelaProdutoID = TirarAcento(desp("TabelaProdutoID"))
