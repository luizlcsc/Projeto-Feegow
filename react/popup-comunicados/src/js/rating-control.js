...
RatingControl.prototype = {
    setRating: function (rating, options) {
        ...
        self.selectedRatingElement.style.display = 'inherit';
        var options = options || {};
        var startTime;
    ...
    setSliderPosition: function (position) {
        ...
        self.ratingElements.forEach(function (element, index) {
            ...
            element.label.style.transform = "translateY(" + self.interpolatedValue(0, 0, adjustedProgress) + "px)";
...
document.querySelector("#csat-container").classList.add("clip-marker");
