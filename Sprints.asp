...
<script type="text/javascript">
    ...
    %>
    $("#rbtns").html('<a title="Lista" href="?P=listaSprints&Pers=1" class="btn btn-sm btn-default"><i class="fa fa-list"></i></a> <a title="Histórico de Alterações" href="javascript:log()" class=\"btn btn-sm btn-default hidden-xs\"><i class=\"fa fa-history\"></i></a>');
</script>
