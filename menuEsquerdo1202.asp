        ...
        <li class="row sidebar-stat hidden-xs">
            <div class="col-sm-12">
              <div class="panel">
                ...
                <% if (session("Banco")="clinic5760" and session("Admin")=1) or session("Banco")<>"clinic5760" then %>
                <div class="panel-footer br-t p12">
                  <span class="fs11">
                        <button onclick="location.href='./?P=HelpDesk&Pers=1';" class="btn btn-sm btn-block btn-primary"><i class="fa fa-comments-o"></i> MEUS CHAMADOS (0)</button>
                  </span>
                </div>
                <% end if %>
              </div>
...
<%
    ...
    case "eventos_emailsms", "sys_smsemail", "configeventos"
        %>
        <li>
            <a href="?P=eventos_emailsms&Pers=0"><span class="fa fa-calendar bigger-110"></span> <span class="sidebar-title">Eventos</span></a>
        </li>
        <%
    ...
    case "pacientes"
        if isnumeric(req("I")) and req("I")<>"" then
            ...
            %>
            <li>
                <a data-toggle="tab" class="tab" id="abaProdutdosUtilizados" href="#pront" onclick="pront('timeline.asp?PacienteID=<%=req("I")%>&Tipo=|ProdutosUtilizados|');">
            ...
            'ODONTOGRAMA
            if (session("Banco")="clinic2901" or session("Banco")="clinic3656" or session("Banco")="clinic100000" or session("Banco")="clinic105" or session("Banco")="clinic5676") and 1=1 then
                %>
                <li>
                    <a data-toggle="tab" class="tab" href="#pront" onclick="pront('Odontograma.asp?I=<%=req("I")%>')">
        ...
        elseif req("Pers")="Follow" then 'Listando os pacientes
            ...
            if lcase(session("Table"))="profissionais" and session("Banco")="clinic105" then
                %>
                <div class="col-xs-12">
    ...
    case "profissionais", "profissionalexterno", "profissionaisgrupos", "especialidades"
        if isnumeric(req("I")) and req("I")<>"" and lcase(req("P"))<>"profissionalexterno" and lcase(req("P"))<>"profissionaisgrupos" and lcase(req("P"))<>"especialidades" then
            ...
            <li>
                <a data-toggle="tab" href="#divPermissoes" id="gtProcAgenda" onclick="ajxContent('ProfProcAgenda', <%=req("I")%>, 1, 'divPermissoes');">
            ...
            <li>
                <a data-toggle="tab" href="#divAcesso" onclick="ajxContent('IntegracaoMemed', <%=req("I")%>, 1, 'divAcesso');">
            ...
            if SplitStoneStatus=4 and aut("integracaostone")=1 then %>
            <li>
                <a data-toggle="tab" href="#divAcesso" onclick="ajxContent('IntegracaoStone', <%=req("I")%>, 1, 'divAcesso', '&associationId=5');">
                    <span class="fa fa-usd"></span> <span class="sidebar-title">Integração Stone </span></a>
            </li>
            <%
            end if
		    ...
		    %>
            <li>
                <a href="./?P=Extrato&Pers=1&T=5_<%= req("I") %>" id="gtExtrato">
            	    <span class="fa fa-money"></span> <span class="sidebar-title">Extrato</span></a>
            </li>
            <li>
                <a href="./?P=RepassesAConferir&Pers=1&AccountID=5_<%= req("I") %>&B=1" id="gtRepasses">
            ...
            %>
            <li>
                <a href="?P=Profissionais&Pers=Follow"><span class="fa fa-user-md bigger-110"></span> <span class="sidebar-title">Profissionais</span></a>
            </li>
            <li>
                <a href="?P=ProfissionalExterno&Pers=Follow"><span class="fa fa-user-times bigger-110"></span> <span class="sidebar-title">Profissionais Externos</span></a>
            </li>
            <li>
                <a href="?P=ProfissionaisGrupos&Pers=Follow"><span class="fa fa-users bigger-110"></span> <span class="sidebar-title">Grupos de Profissionais</span></a>
            </li>
            <li>
                <a href="?P=Especialidades&Pers=Follow"><span class="fa fa-stethoscope bigger-110"></span> <span class="sidebar-title">Especialidades</span></a>
            </li>
            <%
        end if
    case "funcionarios"
    ...
    case "configimpressos"
        ...
        <li>
            <a data-toggle="tab" href="#divLaudosProtocolo"><span class="fa fa-file"></span><span class="sidebar-title"></span> Protocolo dos Laudos</a>
        </li>
        <%
    ...
    case "produtos"
        if req("Pers")="1" then
            ...
            <%
              ...
              case "financeiro", "invoice", "solicitacaodecompra", "contascd", "recorrentes", "recorrente", "conferenciacaixa", "caixas", "splits" , "importarconcicartao" , "emissaodeboletos" , "splitscancelamento" , "concilia" , "stoneconcilia" , "conciliacaoprovedor" ,  "repasses", "regerarrepasses", "extrato", "chequesrecebidos", "cartaocredito", "faturacartao", "detalhamentofatura", "buscapropostas", "gerarrateio", "propostas", "pacientespropostas", "repassesaconferir", "repassesconferidos", "arquivoretorno", "notafiscal","fechamentodedata"
              %>
    ...
    case "relatorios"
            ...
            <ul class="nav sub-nav">
                ...
                <li class="hidden">
                    <a href="#" onClick="callReport('ProdutividadeSintetico');">
                        <i class="fa fa-double-angle-right"></i>
                        Produtividade - Sintético <span class="label label-system label-xs fleft">Novo</span>
                    </a>
                </li>
                <li>
                    <a href="https://clinic.feegow.com.br/components/public/reports/r/productivity" target="_blank">
                        <i class="fa fa-double-angle-right"></i>
                        Produtividade - Analítico <span class="label label-system label-xs fleft">Novo</span>
                    </a>
                </li>
                <%
                end if
            ...
            <ul class="nav sub-nav">
                ...
                <li class="hidden">
                    <a href="https://clinic.feegow.com.br/components/public/reports/r/medical-transfer" target="_blank">
                        <i class="fa fa-double-angle-right"></i>
                        Repasses - Analítico <span class="label label-system label-xs fleft">Novo</span>
                    </a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul class="nav sub-nav">
                ...
                <%
                if aut("|formsaeV|")=1 and lcase(session("Table"))="profissionais" and session("Banco")="clinic6081" then
                %>
                <li>
...
if session("AutoConsolidar")="S" and (session("Banco")="clinic5760" or session("Banco")="clinic100000" or session("Banco")="clinic6221" or session("Banco")="clinic6118" or session("Banco")="clinic6102") then
    %>
