...
<div class="clearfix form-actions">
	<div class="col-md-8">
	    <h4 class="lighter blue"><i class="fa fa-envelope"></i> Enviar E-mail</h4>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-2">
                <button type="button" class="btn btn-primary"><i class="fa fa-arrow-right"></i> ENVIAR</button>
            </div>
            <div class="col-md-4">
    ...
    <div class="col-md-4">
    	<h4 class="lighter blue"><i class="fa fa-tag"></i> Gerar Etiquetas</h4>
        <div class="row">
