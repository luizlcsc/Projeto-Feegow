...
'/original
		...
		if ItemID="0" then
            sqlExecute = "insert into tissprocedimentossadt (CalcularEscalonamento,GuiaID, ProfissionalID, Data, HoraInicio, HoraFim, ProcedimentoID, TabelaID, CodigoProcedimento, Descricao, Quantidade, ViaID, TecnicaID, Fator, ValorUnitario, ValorTotal, sysUser, Associacao,TotalCH,TotalValorFixo,TotalUCO,TotalPORTE,TotalFILME,TotalGeral,CalculoConvenioID,CalculoPlanoID,CalculoContratos)"&_
                         "values (COALESCE(NULLIF('"&treatval(ref("CalcularEscalonamento"))&"',''),1),"&GuiaID&", "& treatvalzero(rfProfissionalID) &", "&myDateNULL(ref("Data"))&", "&myTime(ref("HoraInicio"))&", "&myTime(ref("HoraFim"))&", '"&ref("gProcedimentoID")&"', '"&ref("TabelaID")&"', '"&ref("CodigoProcedimento")&"', '"&ref("Descricao")&"', '"&ref("Quantidade")&"', "&treatValZero(ref("ViaID"))&", "&treatValZero(ref("TecnicaID"))&", "&treatvalzero(ref("Fator"))&", "&treatvalzero(ref("ValorUnitario"))&", "&treatvalzero(ref("ValorTotal"))&", '"&session("User")&"', "& treatvalnull(rfAssociacao)&", "&treatvalzero(ref("TotalCH"))&", "&treatvalzero(ref("TotalValorFixo"))&", "&treatvalzero(ref("TotalUCO"))&", "&treatvalzero(ref("TotalPORTE"))&", "&treatvalzero(ref("TotalFILME"))&", "&treatvalzero(ref("xTotalGeral"))&", "&ref("gConvenioID")&", "&treatvalzero(ref("PlanoID"))&",NULLIF('"&ref("ContratadoSolicitanteCodigoNaOperadora")&"',''))"
            db.execute(sqlExecute)
			...
			sqlExecute = "update tissprocedimentossadt set CalcularEscalonamento="&treatval(ref("CalcularEscalonamento"))&", ProfissionalID="& treatvalzero(rfProfissionalID) &", Data="&myDatenull(ref("Data"))&", HoraInicio="&myTime(ref("HoraInicio"))&", HoraFim="&myTime(ref("HoraFim"))&", ProcedimentoID='"&ref("gProcedimentoID")&"', TabelaID='"&ref("TabelaID")&"', CodigoProcedimento='"&ref("CodigoProcedimento")&"', Descricao='"&ref("Descricao")&"', Quantidade='"&ref("Quantidade")&"', ViaID="&treatValZero(ref("ViaID"))&", TecnicaID="&treatValZero(ref("TecnicaID"))&", Fator='"&treatval(ref("Fator"))&"', ValorUnitario='"&treatval(ref("ValorUnitario"))&"', ValorTotal='"&treatval(ref("ValorTotal"))&"', sysUser='"&session("User")&"', Associacao="& treatvalnull(rfAssociacao) &",TotalCH = "&treatvalzero(ref("TotalCH"))&",TotalValorFixo = "&treatvalzero(ref("TotalValorFixo"))&",TotalUCO="&treatvalzero(ref("TotalUCO"))&",TotalPORTE="&treatvalzero(ref("TotalPORTE"))&",TotalFILME="&treatvalzero(ref("TotalFILME"))&",TotalGeral="&treatvalzero(ref("xTotalGeral"))&",CalculoConvenioID="&ref("gConvenioID")&",CalculoPlanoID="&ref("PlanoID")&",CalculoContratos=NULLIF('"&ref("ContratadoSolicitanteCodigoNaOperadora")&"','') where id="&ItemID
            db.execute(sqlExecute)
