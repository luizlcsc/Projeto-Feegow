        ...
        <li class="row sidebar-stat">
            ...
            if aut("|agendaV|")=1 then
                    ...
                    <select name="EquipamentoID" id="EquipamentoID" class="form-control select2-single">
                        <%
                set Prof = db.execute("select id, NomeEquipamento, '#CCC' Cor from equipamentos where sysActive=1 order by NomeEquipamento")
                while not Prof.EOF
                        %>
                        <option style="border-left: <%=Prof("Cor")%> 10px solid; background-color: #fff;" value="<%=Prof("id")%>" <%=selected%>><%=ucase(Prof("NomeEquipamento"))%></option>
                        <%
                Prof.movenext
                wend
                Prof.close
                set Prof = nothing
                    ...
                    <span class="input-group-addon img-thumbnail" id="ObsAgenda" data-content="" title="" data-placement="left" data-rel="popover" class="btn btn-xs tooltip-info pull-right" data-original-title="Observações da Agenda">
...
<%
    ...
    case "pacientes"
        if isnumeric(req("I")) and req("I")<>"" then
            ...
            'ODONTOGRAMA
            if (session("Banco")="clinic2901" or session("Banco")="clinic100000") and 1=2 then
                %>
                <li>
            ...
            if session("OtherCurrencies")="phone" then
                %>
                <li>
                    <a data-toggle="tab" class="tab" href="#pacienteCalls" onclick="ajxContent('pacienteCalls&Contato=3_<%=req("I")%>', '<%=req("I")%>', '1', 'pacienteCalls')">
            ...
            if session("banco")="clinic100000" or session("banco")="clinic105" or session("banco")="clinic" then
                %>
                <li>
                    <a data-toggle="tab" class="tab" id="tabExtrato" href="#divSUS" onclick="ajxContent('pacienteSUS', '<%=req("I")%>', '1', 'pront')">
                        <span class="fa fa-plus"></span>
                        <span class="sidebar-title">SUS</span>
                    </a>
                </li>
                <%
            end if
    ...
    case "procedimentos"
        ...
        <li>
            <a data-toggle="tab" href="#divMateriais" onclick="ajxContent('procedimentoskits', <%=req("I") %>, 1, 'procedimentoskits')"><span class="fa fa-medkit"></span> <span class="sidebar-title">Materiais e Kits</span></a>
        </li>
        <li>
        ...
        <li>
            <a data-toggle="tab" class="lembrete-pre-pos-menu" href="#divLembretePrePos" onclick="ajxContent('procedimentoslembreteprepos', <%=req("I") %>, 1, 'divLembretePrePos')"><span class="fa fa-retweet"></span> <span class="sidebar-title">Lembrete Pré/Pós</span></a>
        </li>
        <%
        end if
    case "profissionais"
    ...
    case "outrasconfiguracoes"
        ...
        <li>
            <a data-toggle="tab" href="#divIntegracoes" onclick="ajxContent('integracoes', '', 1, 'divIntegracoes');">
            	<span class="fa fa-plug"></span> <span class="sidebar-title">Integrações</span></a>
        </li>
        <%
        if session("banco") = "clinic2803" then
            %>
            <li>
                <a data-toggle="tab" href="#divRegrasDeFormulario" onclick="ajxContent('regrasdeformulario', '', 1, 'divRegrasDeFormulario');">
                    <span class="fa fa-bar-chart"></span> <span class="sidebar-title">Regras de formulário</span></a>
            </li>
            <%
        end if
    case "produtos"
    ...
    case "financeiro", "invoice", "contascd", "recorrentes", "recorrente", "caixas", "repasses", "regerarrepasses", "extrato", "chequesrecebidos", "cartaocredito", "buscapropostas", "gerarrateio", "propostas", "pacientespropostas"
        %>
    ...
    case "relatorios"
        ...
        <li>
            ...
            <ul class="nav sub-nav">
                ...
                <li>
                    <a href="javascript:callReport('rpPerfil', 'Aniversario');">
                        <i class="fa fa-double-angle-right"></i>
                        Aniversariantes
                    </a>
                </li>
        ...
        <li>
            ...
            <ul class="nav sub-nav">
                ...
                if aut("guiasV") then
                    %>
                    <li>
                        <a href="#" onClick="javascript:callReport('ControleGlosa');">
                            <i class="fa fa-double-angle-right"></i>
                            Controle de Glosa
                        </a>
                    </li>
...
if device()<>"" then
    ...
    %>
    <li class="sidebar-label pt20">NAVEGAÇÃO GERAL</li>
