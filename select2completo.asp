        ...
        <div class="col-md-9" role="main">
            ...
            <section>
                ...
                <figure class="highlight">
                    <pre><code class="language-html" data-lang="html"><table style="border-spacing: 0"><tbody><tr><td class="gutter gl" style="text-align: right"><pre class="lineno">1
2
3
4
5
...
<span class="nt">&lt;/label&gt;</span><span class="w">
    ...
    <a href="https://github.com/jamesallardice/Placeholders.js">the Placeholders.js polyfill</a>.
            ...
            <section>
                ...
                <h1 id="data" class="page-header">Data sources
                </h1>
...
<span class="nt">&lt;/select&gt;</span><span class="w">
    ...
    <a href="options.html#ajax">options documentation for <code>ajax</code></a>.
                ...
                <figure class="highlight">
                    <pre><code class="language-js" data-lang="js"><table style="border-spacing: 0"><tbody><tr><td class="gutter gl" style="text-align: right"><pre class="lineno">1
2
3
4
5
...
<span class="nt">&lt;/select&gt;</span><span class="w">
            ...
            <section>
                <h1 id="multiple-max">Limiting the number of selections
                </h1>
...
<span class="p">});</span><span class="w">
            ...
            <section>
                <h1 id="programmatic-control" class="page-header">Programmatic control
                </h1>
...
<span class="p">});</span><span class="w">
            ...
            <section>
                <h1 id="localization-rtl-diacritics" class="page-header">Localization, RTL and diacritics support
                </h1>
...
<span class="p">});</span><span class="w">
    ...
    select below.
                ...
                <div class="s2-example">
                    <p>
                        <select class="js-example-diacritics form-control">
                            <option>Aer�bics</option>
                            <option>Aer�bics en Agua</option>
                            <option>Aerograf�a</option>
                            <option>Aeromodelaje</option>
                            <option>�guilas</option>
                            <option>Ajedrez</option>
                            <option>Ala Delta</option>
                            <option>�lbumes de M�sica</option>
                            <option>Alusivos</option>
                            <option>An�lisis de Escritura a Mano</option>
                        </select>
                    </p>
                </div>

                <figure class="highlight">
                    <pre><code class="language-js" data-lang="js"><table style="border-spacing: 0"><tbody><tr><td class="gutter gl" style="text-align: right"><pre class="lineno">1</pre></td><td class="code"><pre><span class="nx">$</span><span class="p">(</span><span class="s2">".js-example-diacritics"</span><span class="p">).</span><span class="nx">select2</span><span class="p">();</span><span class="w">
</span></pre></td></tr></tbody></table></code></pre>
                </figure>
            </section>
            ...
            <section>
                ...
                <h1 id="themes-templating-responsive-design" class="page-header">Themes, templating and responsive design
                </h1>
        ...
        <div class="col-md-3" role="complementary">
            ...
            <nav class="s2-docs-sidebar hidden-print hidden-xs hidden-sm">
                <ul class="nav s2-docs-sidenav">
                    ...
                    <li>
                        <a href="#themes-templating-responsive-design">Themes, templating and responsive design
                        </a>
                        <ul class="nav">
                            <li>
