const CsatPopup = (props) => {
    ...
    script.src = "react/popup-comunicados/src/js/rating-control.js?a=2";
    script.async = true;

    document.body.appendChild(script);

    return (
        <div id="popup-comunicado" className={"popup-csat"} style={{backgroundColor: "#fff"}}>
            <link type="text/css" rel="stylesheet" href="react/popup-comunicados/src/css/rating.css" />
            
            <div id="csat-pesquisa" >
                  <h3 class="m5 ">Como está sua satisfação com o Feegow Clinic?</h3>
                  <p class="m5" style={{color:"#ababab"}}>Nosso compromisso é te deixar satisfeito.</p>
                  
            <div className="demo-container clip-marker" id="csat-container">

<div className="rating-control">
    <div onClick={() => {
            setRating(1)
            }} className="rating-option" rating="1" selected-fill="#ff9a8e">
        <div className="icon" style={{transform: "scale(1)"}}>
        ...
        <div className="label csat-subtitle" style={{transform: "translateY(0px)",}}>Muito insatisfeito</div>
        <div className="touch-marker"></div>
    </div>
    <div onClick={() => {
            setRating(2)
            }} className="rating-option" rating="2" selected-fill="#ffbd87">
        <div className="icon" style={{transform: "scale(1)"}}>
            <svg width="100%" height="100%" viewBox="0 0 50 50">
                <path d="M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25"
                      className="base" fill="#C6CCD0"></path>
        ...
        <div className="label" style={{transform: "translateY(0px)", color: "rgb(171, 178, 182)"}}>Insatisfeito</div>
        <div className="touch-marker"></div>
    </div>
    <div onClick={() => {
            setRating(3)
            }} className="rating-option" rating="3">
        <div className="icon" style={{transform: "scale(1)"}}>
            <svg width="100%" height="100%" viewBox="0 0 50 50">
                <path d="M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25"
                      className="base" fill="#C6CCD0"></path>
        ...
        <div className="label" style={{transform: "translateY(0px)", color: "rgb(171, 178, 182)"}}>Indiferente</div>
        <div className="touch-marker"></div>
    </div>
    <div onClick={() => {
            setRating(4)
            }} className="rating-option" rating="4" selected-fill="#b1d644">
        <div className="icon" style={{transform: "scale(1)"}}>
            <svg width="100%" height="100%" viewBox="0 0 50 50">
                <path d="M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25"
                      className="base" fill="#C6CCD0"></path>
        ...
        <div className="label" style={{transform: "translateY(0px)", color: "rgb(171, 178, 182)"}}>Satisfeito</div>
        <div className="touch-marker"></div>
    </div>
    <div onClick={() => {
            setRating(5)
            }} className="rating-option" rating="5" selected-fill="#4ed117">
        <div className="icon" style={{transform: "scale(1)"}}>
            <svg width="100%" height="100%" viewBox="0 0 50 50">
                <path d="M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25"
                      className="base" fill="#C6CCD0"></path>
        ...
        <div className="label" style={{transform: "translateY(0px)", color: "rgb(171, 178, 182)"}}>Muito satisfeito</div>
        <div className="touch-marker"></div>
    </div>
    <div className="current-rating" style={{transform: "translateX(100%)", display: "none"}}>
        <div className="svg-wrapper">
            <svg width="55px" height="55px" viewBox="0 0 50 50">
                <path d="M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25"
                      className="base" fill="rgba(255,195,133,1)"></path>
                <path d="M25,31.9996 C21.7296206,31.9996 18.6965022,32.5700242 15.3353795,33.7542598 C14.2935825,34.1213195 13.7466,35.2634236 14.1136598,36.3052205 C14.4807195,37.3470175 15.6228236,37.894 16.6646205,37.5269402 C19.617541,36.4865279 22.2066846,35.9996 25,35.9996 C28.1041177,35.9996 31.5196849,36.5918872 33.0654841,37.4088421 C34.0420572,37.924961 35.2521232,37.5516891 35.7682421,36.5751159 C36.284361,35.5985428 35.9110891,34.3884768 34.9345159,33.8723579 C32.7065288,32.6948667 28.6971052,31.9996 25,31.9996 Z"
                      className="mouth" fill="#655F52"></path>
                <path d="M30.7014384,16.8148522 C30.8501714,16.5872449 31.0244829,16.3714627 31.2243727,16.1715729 C32.054483,15.3414625 33.1586746,14.9524791 34.2456496,15.0046227 C34.8805585,15.7858887 34.945378,15.8599243 35.5310714,16.593811 C36.1167648,17.3276978 36.1439252,17.3549194 36.5988813,17.9093628 C37.0538374,18.4638062 37.2801558,18.7149658 38,19.6496386 C37.8693903,20.4473941 37.496466,21.2131881 36.8812269,21.8284271 C35.3191298,23.3905243 32.7864699,23.3905243 31.2243727,21.8284271 C29.8621654,20.4662198 29.6878539,18.3659485 30.7014384,16.8148522 Z"
                      className="right-eye" fill="#655F52"></path>
                <path d="M18.8284271,21.8284271 C20.1906345,20.4662198 20.3649459,18.3659485 19.3513614,16.8148522 C19.2026284,16.5872449 19.0283169,16.3714627 18.8284271,16.1715729 C17.9983168,15.3414625 16.8941253,14.9524791 15.8071502,15.0046227 C15.1722413,15.7858887 15.1074218,15.8599243 14.5217284,16.593811 C13.9360351,17.3276978 13.9088746,17.3549194 13.4539185,17.9093628 C12.9989624,18.4638062 12.772644,18.7149658 12.0527998,19.6496386 C12.1834095,20.4473941 12.5563339,21.2131881 13.1715729,21.8284271 C14.73367,23.3905243 17.26633,23.3905243 18.8284271,21.8284271 Z"
                      className="left-eye" fill="#655F52"></path>
            </svg>
        </div>
        <div className="touch-marker"></div>
    </div>
...
<div id="csat-notes-content" style={{display: "none"}} >
      <div className="row">

            <div className="col-md-12">
                  <h4 className="text-system">
                        {afterRatingMessage}
                  </h4>
            </div>

            <div className="col-md-12" id="csat-insatisfeito-content" style={{display: "none"}}>
                  <div className="form-group">
                        <p className="csat-subtitle">O que causou a sua insatisfação?</p>

                        <div className="row">
                              <div className="col-md-6">
                                    <div class="checkbox-custom checkbox-system">
                                          <input type="checkbox" id="csat-motivo-1" value="1"/>
                                          <label for="csat-motivo-1" class="checkbox"> Atendimento / Suporte</label>
                                    </div>
                              </div>

                              <div className="col-md-6">
                                    <div class="checkbox-custom checkbox-system">
                                          <input type="checkbox" id="csat-motivo-2" value="2"/>
                                          <label for="csat-motivo-2" class="checkbox"> Usabilidade do sistema</label>
                                    </div>
                              </div>
                              
                              <div className="col-md-6">
                                    <div class="checkbox-custom checkbox-system">
                                          <input type="checkbox" id="csat-motivo-3" value="3"/>
                                          <label for="csat-motivo-3" class="checkbox"> Problemas no sistema (bugs)</label>
                                    </div>
                              </div>

                              <div className="col-md-6">
                                    <div class="checkbox-custom checkbox-system">
                                          <input type="checkbox" id="csat-motivo-4" value="4"/>
                                          <label for="csat-motivo-4" class="checkbox"> Treinamento / Implantação </label>
                                    </div>
                              </div>

                              <div className="col-md-6">
                                    <div class="checkbox-custom checkbox-system">
                                          <input type="checkbox" id="csat-motivo-5" value="5"/>
                                          <label for="csat-motivo-5" class="checkbox"> Outros (descreva) </label>
                                    </div>
                              </div>
                        </div>
     ...
     <div className="row">
            <div className="col-md-12">
                  <textarea onchange="setRating(rating)" style={{fontSize: "13px"}} placeholder={notesPlaceholder}
                  name="csat-notes" value={notes} id="csat-notes" className="form-control input-v2"></textarea>
            </div>
      </div>

      <button onClick={() => {
            endSurvey()
      }} className="btn btn-success mt10 csat-btn-submit">Enviar avaliação</button>
</div>
            ...
            <div id="csat-agradecimento" className="text-center" style={{display: "none"}}>
                  <div>
                        <img style={{height: "70px"}} className="mb15" src="https://i2.wp.com/blog.stylingandroid.com/wp-content/uploads/2017/06/toggle_checked.png?resize=240%2C240&ssl=1"/>
                  </div>

                  <h3 class=" m5 ">Obrigado pelo feedback!</h3>
                  <p class="m5" style={{color:"#ababab"}}>Sua opinião é muito importante para nós.</p>
                  
            </div>

            <div id="csat-nao-exibir">
                  <button onClick={() => {
                  cancelSurvey()
            }} className="btn btn-default btn-sm mt10 csat-btn-submit">Não exibir novamente</button>
            </div>
