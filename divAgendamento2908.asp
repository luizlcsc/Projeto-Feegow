					...
					%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="divChegada" style="display:<%=disCheg%>">
						        ...
						        <%= quickField("text", "Chegada", "", 2, Chegada, "", "", " input-mask-time ") %>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-condensed">
                            <thead>
                                <tr class="info">
                                    ...
                                    <th width="1%"><button type="button" onclick="procs('I', 0, <%=LocalID%>, '<%=Convenios%>', '<%=GradeApenasProcedimentos%>', '<%=GradeApenasConvenios%>')" class="btn btn-xs btn-success"><i class="fa fa-plus"></i></button></th>
                                </tr>
                            </thead>
                            <tbody id="bprocs">
                                        ...
                                        <div class="col-md-12" id="divConvenio"<% If rdValorPlano<>"P" Then %> style="display:none"<% End If %>>
                                            ...
                                            if not isnull(ConvenioID) and ConvenioID<>"" then
                                                ...
                                                if not ConvenioSQL.eof then
                                                    ...
                                                    %>
                                                    <button title="Observações do convênio" id="ObsConvenios" style="z-index: 99;position: absolute;left:-12px" class="btn btn-system btn-xs" type="button" onclick="openModal('<%=replace(replace(ObsConvenio,chr(10),"<br>"),chr(13),"<br>")%>', 'Observações do convênio', true, false, 'md')"><i class="fa fa-align-justify"></i></button>
                                                    <%
                                                end if
                                            end if
...
function procs(A, I, LocalID, Convenios, GradeApenasProcedimentos, GradeApenasConvenios) {
    if(A=='I'){
