...
if req("Part")="" then'primeira parte do processo
	...
	if not verify.EOF then
		...
		dbc.execute("insert into licencas (NomeContato, Telefone, Celular, IP, FimTeste, Cupom, ComoConheceu, referrer, gclid) values ('"&ref("NomeContato")&"', '"&ref("Telefone")&"', '"&ref("Celular")&"', '"&request.ServerVariables("REMOTE_ADDR")&"', "&mydatenull(date()+7)&", '"&ref("Cupom")&"', '"&ref("ComoConheceu")&"', '"&ref("referrer")&"', '"&ref("gclid")&"')")
