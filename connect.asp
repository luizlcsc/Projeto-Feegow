...
'componentslegacyurl = "http://localhost:8080/feegow_components/"
...
private function atuAge(AgendamentoID)
    ...
    db_execute("update agendamentos ag SET ag.Procedimentos='"& rep(Procedimentos) &"' where ag.id="& AgendamentoID)
end function
