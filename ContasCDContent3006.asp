        ...
        while Vencto<=cdate(ref("Ate"))
            ...
            if instr(Geradas, "|"& cFix &"|")=0 then
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="javascript:if(confirm('Esta conta fixa está prevista. Ao editá-la a mesma será consolidada. Deseja prosseguir?'))consolidar(<%=fixa("id")%>, <%=cFix %>, '<%=Vencto %>')"><i class="fa fa-edit grey bigger-130"></i></a>
                        </div>
                    </td>
                </tr>
                <%
