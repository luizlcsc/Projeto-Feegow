...
while not sms.eof
	...
	ConnStringCLIENTE = "Driver={MySQL ODBC 5.3 ANSI Driver};Server=localhost;Database=clinic"&sms("LicencaID")&";uid="&objSystemVariables("FC_MYSQL_USER")&";pwd="&objSystemVariables("FC_MYSQL_PASSWORD")&";"
...
while not emails.eof
	...
	ConnStringCLIENTE = "Driver={MySQL ODBC 5.3 ANSI Driver};Server=localhost;Database=clinic"&emails("LicencaID")&";uid="&objSystemVariables("FC_MYSQL_USER")&";pwd="&objSystemVariables("FC_MYSQL_PASSWORD")&";"
	Set dbCLIENTE = Server.CreateObject("ADODB.Connection")
	dbCLIENTE.Open ConnStringCLIENTE
