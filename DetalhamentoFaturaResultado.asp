        ...
        while not ItensFaturaCartaoSQL.eof
            ...
            if not MovementSQL.eof then
                ...
                <tr>
                    ...
                    <td style="display:none"><button type="button" onclick="AlteraFatura('<%=InvoiceID%>')" title="Alterar fatura desta conta" class="btn-default btn btn-xs"><i class="fa fa-arrow-circle-o-right"></i></button></td>
                </tr>
                <%
