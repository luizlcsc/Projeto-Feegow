...
<%
    ...
    case "pacientes"
        if isnumeric(req("I")) and req("I")<>"" then
		    ...
		    %>
            <li>
                <a data-toggle="tab" class="tab menu-aba-pacientes-anamneses" id="abaForms" href="#forms" onclick="pront('timeline.asp?PacienteID=<%=req("I")%>&Tipo=|AE|');">
		    ...
		    %>
            <li>
                <a data-toggle="tab" class="tab menu-aba-pacientes-laudos-formularios" href="#forms" onclick="pront('timeline.asp?PacienteID=<%=req("I")%>&Tipo=|L|');">
		    ...
		    %>
            <li>
                <a data-toggle="tab" class="tab menu-aba-pacientes-diagnosticos" id="tabDiagnosticos" href="#pront" onclick="pront('timeline.asp?PacienteID=<%=req("I")%>&Tipo=|Diagnostico|');">
            ...
            <li>
                <a data-toggle="tab" class="tab menu-aba-pacientes-prescricoes" id="abaPrescricoes" href="#pront" onclick="pront('timeline.asp?PacienteID=<%=req("I")%>&Tipo=|Prescricao|');">
		    ...
		    %>
            <li>
                <a data-toggle="tab" class="tab menu-aba-pacientes-textos-e-atestados" id="abaAtestados" href="#pront" onclick="pront('timeline.asp?PacienteID=<%=req("I")%>&Tipo=|Atestado|');">
		    ...
		    %>
            <li>
                <a data-toggle="tab" class="tab menu-aba-pacientes-pedidos-de-exame" id="abaPedidos" href="#pront" onclick="pront('timeline.asp?PacienteID=<%=req("I")%>&Tipo=|Pedido|');">
        ...
        if isnumeric(req("I")) and req("I")<>"" and lcase(req("P"))<>"profissionalexterno" and lcase(req("P"))<>"profissionaisgrupos" and lcase(req("P"))<>"especialidades" then
            ...
            <li class="">
                <a class="menu-aba-meu-perfil-compartilhamento " data-toggle="tab" href="#divPermissoes" id="gtPermissoes" onclick="ajxContent('CompartilharProntuario&T=<%=request.QueryString("P")%>', <%=request.QueryString("I")%>, 1, 'divPermissoes');">
            	    <span class="fa fa-share-alt"></span> <span class="sidebar-title">Compartilhamento </span><span class="label label-system label-xs fleft">Novo</span> </span></a>
            </li>
