...
<div class="container" role="main">
    <form method="post" action="" enctype="multipart/form-data" novalidate class="box" id="formDropZone">
...
<script>
    ...
    let urlAction = domain + 'api/image/uploadAnyFile';
    $('#formDropZone').attr('action',urlAction);
