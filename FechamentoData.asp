...
if req("t")="Saldos" then
    ...
    %>
    <div class="row p25">
        <div class="col-xs-3"><img width="150" src="https://cdn.saocarlosagora.com.br/img/pc/780/530/dn_noticia/2020/05/amorsaudelogo.jpg?c=1"></div>
...
set pulta = db.execute("select m.Date from sys_financialmovement m where Type<>'Bill' "& sqlMaior &" order by m.Date limit 1")
