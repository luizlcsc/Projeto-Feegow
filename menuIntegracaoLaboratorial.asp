...
<li>
    <a href="?P=labsimportardepara&Pers=1&v=<%=arrayintegracao(1)%>" title="V.<%=arrayintegracao(1)%>"><span class="far fa-download"></span> <span class="sidebar-title">De x Para</span></a>
</li>
<%
end if
%>