...
%>
                        <tr>
                          ...
                          <td nowrap>
			                ...
			                <a href="javascript:if(confirm('Tem certeza de que deseja excluir este modelo?'))ListaProOutros('ProOutros', <%=listaProOutros("id")%>000)" class="btn btn-xs btn-danger" title="" data-placement="top" data-rel="tooltip" data-original-title="Excluir">
