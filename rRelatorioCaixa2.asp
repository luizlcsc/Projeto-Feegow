...
<% end if %>
    ...
    <%= linhaTotais(Balanco, Cheque, Credito, Debito, "FEHCAMENTO DE CAIXA", "alert") %>


<% if MC="1" then %>

<hr />
<div class="alert alert-alert row">
    <%= quickfield("currency", "ValorFechamento", "Digite o Valor de Fechamento", 2, "", "", "", " required ") %>
    <div class="col-md-2">
